...
//
//  Purpose: This file is used to create a custom table cell for displaying buidling data in the UI. This object has two elements a title label for the building name and an detail label.
